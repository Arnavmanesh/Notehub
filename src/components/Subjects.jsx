...
const subjectsData = [
    ...
    },
    {
        ...
        modules: [
            ...
            { badge: "Module 3", title: "Normalization & Transactions", description: "Functional dependencies, 1NF to 3NF, concurrency control, locking techniques, and database recovery.", link: "#" },
    ...
    },
    {
        ...
        modelPaperLink: "#",
        modules: [
            { badge: "Module 1", title: "Process Concepts & Scheduling", description: "OS services, user/kernel modes, context switching, multithreading, and process scheduling algorithms (CFS).", link: "#" },
            { badge: "Module 2", title: "Concurrency & Synchronization", description: "Locks, semaphores, bounded buffer problem, deadlock characterization, prevention, avoidance, and recovery.", link: "#" },
            { badge: "Module 3", title: "Memory Management & Virtual Memory", description: "Address translation, segmentation, paging, TLBs, swap space, page replacement policies, and thrashing.", link: "#" },
            { badge: "Module 4", title: "I/O Systems & File Directories", description: "Programmed I/O, DMA, device drivers, disk scheduling, file descriptor interface, inodes, and mounting.", link: "#" }
        ]
    },
    {
